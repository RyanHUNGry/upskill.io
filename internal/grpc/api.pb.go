...
type GetAnswerResponse struct {
	...
	AnswerScores []*GetAnswerResponse_AnswerScore `protobuf:"bytes,3,rep,name=answer_scores,json=answerScores,proto3" json:"answer_scores,omitempty"`
}
...
func (x *GetAnswerResponse) GetUserId() []byte {
	if x != nil {
		return x.UserId
	}
	return nil
...
func (x *GetAnswerResponse) GetInterviewId() []byte {
	if x != nil {
		return x.InterviewId
	}
	return nil
...
func (x *GetAnswerResponse) GetAnswerScores() []*GetAnswerResponse_AnswerScore {
	if x != nil {
...
func (x *CreateInterviewRequest) GetCompany() string {
	if x != nil {
		return x.Company
	}
	return ""
...
type GetAnswerResponse_AnswerScore struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *GetAnswerResponse_AnswerScore) Reset() {
	*x = GetAnswerResponse_AnswerScore{}
	if protoimpl.UnsafeEnabled {
...
func (x *GetAnswerResponse_AnswerScore) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetAnswerResponse_AnswerScore) ProtoMessage() {}

func (x *GetAnswerResponse_AnswerScore) ProtoReflect() protoreflect.Message {
	mi := &file_api_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetAnswerResponse_AnswerScore.ProtoReflect.Descriptor instead.
func (*GetAnswerResponse_AnswerScore) Descriptor() ([]byte, []int) {
	return file_api_proto_rawDescGZIP(), []int{1, 0}
}

func (x *GetAnswerResponse_AnswerScore) GetScore() float64 {
	if x != nil {
		return x.Score
	}
	return 0
...
func (x *GetAnswerResponse_AnswerScore) GetAnswer() string {
	if x != nil {
		return x.Answer
	}
	return ""
...
func (x *GetAnswerResponse_AnswerScore) GetAnswerIdx() int32 {
	if x != nil {
		return x.AnswerIdx
	}
	return 0
...
func (x *GetAnswerResponse_AnswerScore) GetQuestionIdx() int32 {
	if x != nil {
		return x.QuestionIdx
	}
	return 0
...
var file_api_proto_rawDesc = []byte{
	...
	0x05, 0x52, 0x0b, 0x71, 0x75, 0x65, 0x73, 0x74, 0x69, 0x6f, 0x6e, 0x49, 0x64, 0x78, 0x22, 0x97,
	0x02, 0x0a, 0x11, 0x47, 0x65, 0x74, 0x41, 0x6e, 0x73, 0x77, 0x65, 0x72, 0x52, 0x65, 0x73, 0x70,
	...
	,
	...
	0x6f, 0x6d, 0x70, 0x61, 0x6e, 0x79, 0x12, 0x42, 0x0a, 0x09, 0x71, 0x75, 0x65, 0x73, 0x74, 0x69,
	0x6f, 0x6e, 0x73, 0x18, 0x03, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x24, 0x2e, 0x61, 0x70, 0x69, 0x2e,
	...
	0x09, 0x71, 0x75, 0x65, 0x73, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x1a, 0x26, 0x0a, 0x08, 0x51, 0x75,
	...
	0x6f, 0x6e, 0x42, 0x20, 0x5a, 0x1e, 0x72, 0x79, 0x68, 0x75, 0x6e, 0x67, 0x2e, 0x75, 0x70, 0x73,
	0x6b, 0x69, 0x6c, 0x6c, 0x2e, 0x69, 0x6f, 0x2f, 0x69, 0x6e, 0x74, 0x65, 0x72, 0x6e, 0x61, 0x6c,
...
var file_api_proto_goTypes = []any{
	...
	(*GetAnswerResponse)(nil),               // 1: api.GetAnswerResponse
	(*CreateInterviewRequest)(nil),          // 2: api.CreateInterviewRequest
	(*GetAnswerResponse_AnswerScore)(nil),   // 3: api.GetAnswerResponse.AnswerScore
	(*CreateInterviewRequest_Question)(nil), // 4: api.CreateInterviewRequest.Question
}
var file_api_proto_depIdxs = []int32{
	3, // 0: api.GetAnswerResponse.answer_scores:type_name -> api.GetAnswerResponse.AnswerScore
	4, // 1: api.CreateInterviewRequest.questions:type_name -> api.CreateInterviewRequest.Question
...
func file_api_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_api_proto_msgTypes[3].Exporter = func(v any, i int) any {
			switch v := v.(*GetAnswerResponse_AnswerScore); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
